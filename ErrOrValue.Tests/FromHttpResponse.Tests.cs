...
public class FromHttpResponseTests
{
  ...
  public void TransfersCodeAndMessageFromHttpResponse_Success(HttpStatusCode statusCode, string reasonPhrase)
  {
    // Arrange
    var errOr = new ErrOr();
  ...
  [Fact]
  public async Task TransfersJsonValueFromHttpResponse_Success()
  {
    // Arrange
